...
|                           |                                                                                      |
| ------------------------- | ------------------------------------------------------------------------------------ |
| **Programming languages** | TypeScript, HTML, SVG, JSON, CSS, LESS, SASS, WebGL, XML, JSON, XSLT    |
| **Frameworks**            | Next.js & React, D3.js, Three.js, Mapbox GL JS, Tailwind CSS, XState, Svelte, Nuxt & Vue.js, Node.js, Bun, Playwright, Vercel AI SDK |
| **Tools**                 | VS Code, Cursor, Git, Docker, ChatGPT, Claude Code, Agent Skills, MCP           |
| **Topics**                | User experience, agentic, performance, information visualisation, SEO, eCommerce |
...
Family trees for four large German families. Every dynasty tells its story, we made it graspable. Historical & contemporary context, me & my family, smart edge case handling such patchwork etc. 

Concept & design, architecture, development, integration & training.

**Technologies**: React, gedcom, figma, lovable

### Baselworld – 2021

Frontend lead for the intranet of Baselworld / Houruniverse (now "Watches and Wonders")
...
Relaunch and evolution of the Weg.de / lastminute.com booking portal. Holidays are fun, so should be the onboarding. 

Training the frontend team in component-based client architecture, consulting on technology transfer,  implementing core components and code reviews.
...
Consulting and implementation of QA and CI strategies for microservice-based web applications. Set up processes and tools for measuring software quality, define quality standards and ensure high-quality automated deployments.

Technologies: Docker, npm, Amazon Web Services, TypeScript,l, Drone CI, Jira, Bitbucket, Three.js, WebGL, Next.js.
...
**Technologies**: React, Redux, ES6/7, CSSNEXT, Jest, Enzyme, Webpack, Node.js, Three.js, WebGL.
...
**Technologies**: Oxid Esales, Google Ads, HTML5, JavaScript

[glashaus-gartenkultur.de](glashaus-gartenkultur.de)

### Exelonix GmbH, Dresden – 2013–2014
...
App strategy, UX design & development.

**Technologies**: Java, Android, HTTP

### AVANGA Filmproduktion GmbH & Co. KG, Dresden – 2012–2013

Interactive movie for leading German technology companies targeting trade fairs booth & sales. 
...
### T-Systems MMS, Dresden – 2009–2012, 2014
...
### Vodafone Endowed Chair, TU Dresden – 2008 & 2011
...
### Groupnet, T-Systems MMS, Dresden – 2010
