...
*„Interaktive zweidimensionale Darstellung von Erfahrungszeit basierend auf besuchten Orten"* — Endnote: 1 (≈ A).

### 2009 Forschungsarbeit — Fakultät Informatik, TU Dresden

*„Materialität und Interaktion"*, unbenotet.

### 2002–2009 Nebenfach „Kunst & Design" — HfBK & TU Dresden

*„Annäherung an zeitgenössische Ornamentik mit dem experimentellen Film"* — Endnote: 1,3 (≈ A).
